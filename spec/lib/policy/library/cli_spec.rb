...
RSpec.describe Policy::Library::CLI do
  ...
  shared_examples_for "a version command" do
    it "prints version" do
      result = -> { cli }
      pattern = /#{Regexp.escape Policy::Library::Identity::VERSION_LABEL}\n/o
  ...
  shared_examples_for "a help command" do
    it "prints usage" do
      result = -> { cli }
      pattern = /#{Regexp.escape Policy::Library::Identity::VERSION_LABEL}\scommands:\n/o
